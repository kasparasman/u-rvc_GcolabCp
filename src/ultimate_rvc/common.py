...
CUSTOM_EMBEDDER_MODELS_DIR = RVC_MODELS_DIR / "embedders" / "custom"
CUSTOM_PRETRAINED_DIR = RVC_MODELS_DIR / "pretrained"
CUSTOM_GENERATOR_DIR = CUSTOM_PRETRAINED_DIR / "generator"
CUSTOM_DISCRIMINATOR_DIR = CUSTOM_PRETRAINED_DIR / "discriminator"
